        ...
        <nav class="navbar" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">Charter Freight Services</a>
                        <ul class="nav navbar-nav visible-xs">
                                    <li class="pull-right"><a href="tel:+19057811237"><i class="glyphicon glyphicon-phone"></i></a></li>
                                    <li class="pull-right"><a href="mailto:dispatach@charterfreightservices.com"><i class="glyphicon glyphicon-envelope"></i></a></li>
                                  </ul>
                                  <ul class="nav navbar-nav hidden-xs">
                                    <li class="pull-right"><a href="tel:+19057811237"><i class="glyphicon glyphicon-phone"></i> (905) 781-1237</a></li>
                                    <li class="pull-right"><a href="mailto:dispatach@charterfreightservices.com"><i class="glyphicon glyphicon-envelope"></i> dispatach@charterfreightservices.com</a></li>
                                  </ul>
                    </div>
...
<div class="container-fluid our-services-main-content">
            <div class="row title-row-contact-us text-center background-fixed breadcrumb">
                <div class="col-xs-12">
                    <h1>Contact Us</h1>
                    <h3><a href="index.html">Home</a> <i class="fa fa-angle-double-right" aria-hidden="true"></i> Contact Us</h3>
                </div>
            </div>
</div>
<!-- main content -->
